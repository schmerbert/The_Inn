...
The Marble Manual trilogy and the cabin and lighthouse specimens are included
in this repo at [TheMarble(manual_examples)/](TheMarble(manual_examples)/) —
copies, kept here so every claim in MAP.md that cites a letter, a test, or a
law can be walked to its evidence without leaving the repository. The cabin's
[hostile suite](TheMarble(manual_examples)/cabin/tests/test_hostile.py) and
[letters](TheMarble(manual_examples)/cabin/docs/letters/) are the most cited.
The third ancestor is Trinity/HomeGlobe — the dense exemplar whose beauty and
whose fragility (eleven systems before friction) shaped everything here. She
did not fall. She suffered the catastrophe these laws are scar tissue from —
a narrator that didn't exist, filling her forest — and survived it, at real
cost, and is live today. She is preparing for a move: when this inn has
proven the forest under friction, she gets a new globe built on it. The Inn
is the rehearsal; she is who it's for. We have tried to remember, with every
board we laid, what her fragility taught — and that she was worth learning
it from.
